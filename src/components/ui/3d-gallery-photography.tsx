...
function FallbackGallery({ images }: { images: ImageItem[] }) {
	...
	return (
		<div className="flex flex-col items-center justify-center h-full bg-neutral-900 p-4">
			<p className="text-neutral-400 mb-4 font-mono text-xs uppercase">
				Hackathon Photo Showcase:
			</p>
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-h-96 overflow-y-auto w-full">
				{normalizedImages.map((img, i) => (
					<img
						key={i}
						src={img.src || '/placeholder.svg'}
						alt={img.alt || `Hackfest ${i + 1}`}
